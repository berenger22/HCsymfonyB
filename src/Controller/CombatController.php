...
class CombatController extends AbstractController
{
     ...
     */
    public function index(Professeur $professeur, SerializerInterface $serializer, Request $request)
    {
     ...
     */
    public function getProfesseurQuestions(Professeur $professeur, SerializerInterface $serializer, Session $session, QuestionRepository $questionRepository): Response
    {
     ...
     */
    public function postQuestion(Request $request, Session $session, SerializerInterface $serializer): Response
    {
